...
- Update #file:monafit-tracker/backend/monafit_tracker/views.py to replace the return for the rest api url endpiints with the codespace url http://zany-sniffle-4j9q44x65q4fj56r-8000.app.github.dev for django
- Replace <codespace-name> with zany-sniffle-4j9q44x65q4fj56r
...
@api_view(['GET'])
def api_root(request, format=None):
    base_url = 'http://zany-sniffle-4j9q44x65q4fj56r-8000.app.github.dev/'
    return Response({
        'users': base_url + 'api/users/?format=api',
        'teams': base_url + 'api/teams/?format=api',
        'activities': base_url + 'api/activities/?format=api',
